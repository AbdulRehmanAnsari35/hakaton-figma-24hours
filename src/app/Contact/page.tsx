            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">
                  Pakistan Karachi Orangi town
                  <br /> Sec7/b Near Qatar Street
                </p>
              </div>
              <div>
                <h2 className="text-lg font-medium">Phone</h2>
                <p className="text-gray-700">
                  Mobile: (+92) 3102867896
                  <br />
                  Hotline: (+92) 00000000
                </p>
              </div>
            ...
            <form className="p-6 space-y-6">
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full mt-1 px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-teal-500 focus:border-teal-500"
                  required
                />
              </div>
              <div className="mb-4">
